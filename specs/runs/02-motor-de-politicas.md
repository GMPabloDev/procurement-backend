...
- Resultado: el replay secuencial, snapshots separados (`inputCanonicalJson` contractual + `requestSnapshotJson`) y la serialización están implementados, pero no se declara PASS contractual: faltan pruebas del servicio real sin llamada al provider, concurrencia distribuida, corrupción HTTP 503 y CA-01–CA-12.
- HEAD: `45c5576`.
