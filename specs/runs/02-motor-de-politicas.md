...
> **Actualizado:** 2026-09-10 05:10 -05
> **HEAD de implementación verificado:** `b2fb2fc`
...
| T-09 | Parcial | Unitarias: 43 correctas; IntegrationTests: 10 correctas con SQL Server/Testcontainers, incluyendo provider de facts, publicación sucesora atómica, default-deny, workflow controlado y vectores golden; ApiE2ETests: 2 correctas (incluye health required/corrupt, edición optimista, validación de waiver y ciclo draft/publicación/simulación); `dotnet test --solution ProcureToPay.sln --no-restore`: **55/55** correctas en el último commit verificado; solución compila con 0 advertencias/errores; métricas/logs básicos y adapter HTTP configurable añadidos. Falta ampliar evidencia negativa/golden/API específica de CA-01–CA-12. | `b2fb2fc` / Bloque 4 |
